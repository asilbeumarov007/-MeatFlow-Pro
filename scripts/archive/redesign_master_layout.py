...
<header class="unified-header">
  <div class="header-container">
    ...
    <!-- Center: Vibrant Color-Coded Admin Action Pills -->
    ...
    <div class="header-actions">
      ...
      <div class="dropdown">
        <button class="user-profile-badge dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <span class="user-name d-none d-md-inline">{{ user.username }}</span>
        </button>
        <ul class="dropdown-menu dropdown-menu-end dropdown-luxury shadow-xl p-2 mt-2" style="min-width: 250px;">
          ...
          <li><a class="dropdown-item rounded-3 py-2 fw-semibold" href="{% url 'debt-migration' %}"><i class="bi bi-journal-arrow-up me-2 text-purple"></i> Daftardan Qarz Ko'chirish</a></li>
          <li><a class="dropdown-item rounded-3 py-2 fw-semibold" href="/admin/"><i class="bi bi-database-gear me-2 text-primary"></i> Tizim Boshqaruv (Django)</a></li>
          {% else %}
          <li><a class="dropdown-item rounded-3 py-2 fw-semibold" href="/pos/my-cabinet/"><i class="bi bi-person-vcard me-2 text-success"></i> Shaxsiy Kabinet</a></li>
          {% endif %}
...
<div id="mobile-navbar-dropdown" class="mobile-menu-drawer">
  <div class="d-flex flex-column gap-2">
    {% if user.is_superuser %}
    <a href="{% url 'home' %}" class="nav-pill pill-home w-100 justify-content-start"><i class="bi bi-grid-1x2-fill me-2"></i> Boshqaruv Paneli</a>
    <a href="{% url 'terminal' %}" class="nav-pill pill-terminal w-100 justify-content-start"><i class="bi bi-display-fill me-2"></i> Savdo Terminali</a>
    <a href="{% url 'customers' %}" class="nav-pill pill-customers w-100 justify-content-start"><i class="bi bi-people-fill me-2"></i> Mijozlar Bazasi</a>
    <a href="{% url 'article_list' %}" class="nav-pill pill-ombor w-100 justify-content-start"><i class="bi bi-box-seam-fill me-2"></i> Ombor &amp; Go'shtlar</a>
    <a href="{% url 'cash_flow' %}" class="nav-pill pill-analytics w-100 justify-content-start"><i class="bi bi-cash-stack me-2"></i> Kassa (Kirim-Chiqim)</a>
    <a href="{% url 'yield_loss' %}" class="nav-pill pill-analytics w-100 justify-content-start"><i class="bi bi-calculator-fill me-2"></i> So'yim &amp; Tannarx</a>
    <a href="{% url 'daily_report' %}" class="nav-pill pill-analytics w-100 justify-content-start"><i class="bi bi-graph-up-arrow me-2"></i> Analitika &amp; Hisobotlar</a>
    <a href="{% url 'ai_assistant_page' %}" class="nav-pill pill-ai w-100 justify-content-start"><i class="bi bi-robot me-2"></i> AI Qassob</a>
    {% else %}
    <a href="/pos/my-cabinet/" class="nav-pill pill-home w-100 justify-content-start"><i class="bi bi-person-vcard me-2"></i> Shaxsiy Kabinet</a>
    {% endif %}
  </div>
</div>
...
<footer style="background: #04120C; color: rgba(255,255,255,0.7); padding: 48px 24px 32px; border-top: 1px solid rgba(212,168,83,0.2); font-size: 13.5px; margin-top: 60px;">
  <div style="max-width: 1440px; margin: 0 auto;" class="row g-4">
    ...
    <div class="col-lg-4 col-md-6">
      ...
      <p style="color: rgba(255,255,255,0.6); line-height: 1.6; max-width: 340px;">
        Baxmal Meat Boutique — Halol, muzlatilmagan sarxil mol va qo'y go'shtlari, real vaqtidagi avtomatlashtirilgan kassa va tarozi tizimi.
      </p>
      <div class="d-flex align-items-center gap-2 text-success font-12 fw-bold">
        <i class="bi bi-patch-check-fill font-16"></i> 100% Halol va Sifat Kafolati
      </div>
    </div>
    ...
    <div class="col-lg-2 col-md-6">
      <h6 class="text-white fw-bold mb-3 text-uppercase font-12" style="letter-spacing: 1px; color: #D4A853 !important;">Xizmatlar</h6>
      <ul class="list-unstyled d-flex flex-column gap-2 mb-0">
  ...
  <div style="max-width: 1440px; margin: 32px auto 0; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 20px;" class="d-flex justify-content-between align-items-center flex-wrap gap-2 font-12 text-white-50">
    ...
    <div>Enterprise POS &amp; Scale Ecosystem v3.5</div>
  </div>
</footer>
...
print("SUCCESSFULLY_UPDATED_BASE_HTML")
