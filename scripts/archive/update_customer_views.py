...
<head>
  ...
  <style>
    ...
    /* User Profile Badge (Prominent Top-Right Admin Badge) */
    .user-profile-badge {
...
<header class="unified-header">
  <div class="header-container">
    ...
    <!-- Center: Admin vs Customer Navigation Pills -->
    ...
    <div class="header-actions">
      ...
      <!-- Notification Bell (Only for superuser) -->
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-luxury shadow-xl p-2 mt-2" style="min-width: 250px;">
          ...
          {% else %}
          <li><a class="dropdown-item rounded-3 py-2 fw-semibold" href="/pos/my-cabinet/"><i class="bi bi-person-vcard me-2 text-success"></i> Shaxsiy Kabinet &amp; Buyurtmalarim</a></li>
          {% endif %}
...
<div id="mobile-navbar-dropdown" class="mobile-menu-drawer">
  <div class="d-flex flex-column gap-2">
    ...
    {% else %}
    <a href="{% url 'home' %}" class="nav-pill pill-home w-100 justify-content-start"><i class="bi bi-house-door-fill me-2"></i> Bosh Sahifa</a>
    <a href="{% url 'article_list' %}" class="nav-pill pill-ombor w-100 justify-content-start"><i class="bi bi-shop me-2"></i> Go'sht Katalogi</a>
    <a href="/pos/my-cabinet/" class="nav-pill pill-customers w-100 justify-content-start"><i class="bi bi-person-vcard me-2"></i> Shaxsiy Kabinet</a>
    {% endif %}
  </div>
</div>
...
print("SUCCESSFULLY_UPDATED_CUSTOMER_VIEWS_IN_BASE")
