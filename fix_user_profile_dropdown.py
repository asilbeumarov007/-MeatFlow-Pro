...
<head>
  ...
  <style>
    ...
    .btn-user-profile {
      background: linear-gradient(135deg, rgba(16,185,129,0.25), rgba(212,168,83,0.25));
    ...
    <nav class="navbar navbar-expand-lg navbar-dark p-0">
      ...
      <div class="collapse navbar-collapse" id="mainHeaderNavbar">
        ...
        <div class="navbar-nav mx-auto d-flex flex-wrap gap-2 my-2 my-lg-0">
          {% if user.is_superuser %}
            ...
            <div class="nav-item dropdown">
              <a class="nav-pill-item pill-indigo dropdown-toggle text-decoration-none" href="#" role="button" onclick="toggleDropdownMenu(this, event)">
        ...
        <div class="d-flex align-items-center gap-2 mt-2 mt-lg-0">
          ...
          <div class="dropdown">
            <button class="btn btn-outline-warning btn-sm rounded-circle p-0" style="width:36px; height:36px;" type="button" onclick="loadNotifications(); toggleDropdownMenu(this, event)">
          ...
          <div class="dropdown">
            <button class="btn btn-user-profile border-0" type="button" onclick="toggleDropdownMenu(this, event)">
              <div class="user-avatar-circle">
                {{ user.username|slice:":1"|upper }}
              </div>
              <span>{{ user.username }}</span>
              <i class="bi bi-chevron-down opacity-75 font-10 ms-1"></i>
            </button>
...
<script>
function toggleDropdownMenu(btn, e) {
  if (e) {
    e.stopPropagation();
    e.preventDefault();
  }
...
print("SUCCESSFULLY_FIXED_USER_PROFILE_DROPDOWN")
